...
function LanguagePack.LoadBranch(Branch)
	Language = {
		EN = {
          ...
          RipIndra = "Auto Rip Indra (True Form)",
          RequireColors = "(Requires colors)",
          HakiPads = "Auto Enable Colors"
				},
				Items = {
					Sections = {
            ...
            Accessories = "Accessories"
					...
					AutoGodHuman = "Auto Godhuman",
          NotRecommended = "Not recommended",
          Yama = "Auto Yama",
          Tushita = "Auto Tushita",
          CDK = "Auto Cursed Dual Katana",
          Stone = "Pilot Helmet",
          HopFor = "Hops Servers for: ",
          PilotHelmet = "Auto Pilot Helmet",
          Lei = "Auto Lei",
          Valkyrie = "Auto Valkyrie Helm",
          PaleScarf = "Auto Pale Scarf",
          CoolShades = "Auto Cool Shades",
          Coat = "Auto Coat",
          CoatPink = "Auto Pink Coat",
          ColoredCoats = "Auto Red/Blue Coat",
          BlackCoat = "Auto Black Coat"
				},
				Config = {
					Sections = {
						Attack = "Attack",
		...
		PT = {
          ...
          RipIndra = "Auto Rip Indra (Verdadeira Forma)",
          RequireColors = "(Requer Cores)",
          HakiPads = "Auto Ativar Cores"
				},
				Items = {
					Sections = {
          ...
          CDK = "Auto CDK",
          HopFor = "Procura por: ",
          PilotHelmet = "Auto Capacete do Piloto",
          Lei = "Auto Lei",
          Valkyrie = "Auto Elmo Valkyria",
          PaleScarf = "Auto Cachecol Pálido",
          CoolShades = "Auto Óculos Legais",
          Coat = "Auto Capa",
          CoatPink = "Auto Capa Rosa",
          ColoredCoats = "Auto Capa Azul/Vermelha",
          BlackCoat = "Auto Capa Preta"
				},
				Config = {
					Sections = {
						Attack = "Ataque",
...
function LanguagePack.LoadLanguage(language)
	local LoadedLanguage = Language[language] or Language.EN;
